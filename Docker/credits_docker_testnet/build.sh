wget https://credits.com/Content/file_users/Credits_Node_linux_x64_ver_4.2.416.1_testnet.tar.gz -P build Credits_Node_linux_x64_ver_4.2.416.1_testnet.tar.gz
